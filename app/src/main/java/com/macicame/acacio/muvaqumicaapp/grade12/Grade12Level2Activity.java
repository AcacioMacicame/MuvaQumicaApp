...
public class Grade12Level2Activity extends AppCompatActivity {
...
//    int mScore = intent.getIntExtra("score", 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade12_level2);
        ...
        controller.grade12Level2Questions(getApplicationContext());
        updateQuestion();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<controller.getLength() ){
            ...
            Toast.makeText(Grade12Level2Activity.this, "Nivel 2 Completo!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Grade12Level2Activity.this, Grade12Level2ScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Grade12Level2Activity.this, "Opção correcta!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Grade12Level2Activity.this, "Opss, opção Errada!", Toast.LENGTH_SHORT).show();
