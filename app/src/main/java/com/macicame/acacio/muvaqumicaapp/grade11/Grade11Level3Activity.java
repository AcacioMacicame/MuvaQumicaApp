...
public class Grade11Level3Activity extends AppCompatActivity {
...
//    int mScore = intent.getIntExtra("score", 0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade11_level3);
        ...
        controller.grade11Level3Questions(getApplicationContext());
        updateQuestion();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<controller.getLength() ){
            ...
            Toast.makeText(Grade11Level3Activity.this, "Nivel 3 Completo!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Grade11Level3Activity.this, Grade11Level3ScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Grade11Level3Activity.this, "Opção correcta!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Grade11Level3Activity.this, "Opss, opção Errada!", Toast.LENGTH_SHORT).show();
