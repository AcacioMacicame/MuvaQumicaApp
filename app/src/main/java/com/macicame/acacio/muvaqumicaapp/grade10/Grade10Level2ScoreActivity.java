...
public class Grade10Level2ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade10_level2_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade10Level2ScoreActivity.this, Grade10Level2Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade10Level2ScoreActivity.this, Grade10Level3Activity.class);
        startActivity(intent);
    }
}
