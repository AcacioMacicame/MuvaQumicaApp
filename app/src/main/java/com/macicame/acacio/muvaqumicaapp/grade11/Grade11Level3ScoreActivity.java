...
public class Grade11Level3ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade11_level3_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade11Level3ScoreActivity.this, Grade11Level3Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade11Level3ScoreActivity.this, Grade11ReportActivity.class);
        startActivity(intent);
    }
}
