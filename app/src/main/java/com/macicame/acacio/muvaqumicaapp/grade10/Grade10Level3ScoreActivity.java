...
public class Grade10Level3ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade10_level3_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade10Level3ScoreActivity.this, Grade10Level3Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade10Level3ScoreActivity.this, Grade10ReportActivity.class);
        startActivity(intent);
    }
}
