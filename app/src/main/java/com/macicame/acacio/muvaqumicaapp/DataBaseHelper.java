...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    // Database name
    public static String DATABASE_QUESTION = "chemistry.db";
     ...
     * Question
     */
    public List<Question> getAllGrade10Level1QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "10" + " AND " + LEVEL + " = " + "1";
        ...
        if (c.moveToFirst()) {
            do {
                ...
                String gradeText= c.getString(c.getColumnIndex(GRADE));
                question.setGrade(gradeText);

                String levelText = c.getString(c.getColumnIndex(LEVEL));
                question.setLevel(levelText);
    ...
    public List<Question> getAllGrade10Level2QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "10" + " AND " + LEVEL + " = " + "2";
    ...
    public List<Question> getAllGrade10Level3QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "10" + " AND " + LEVEL + " = " + "3";
    ...
    public List<Question> getAllGrade11Level1QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "11" + " AND " + LEVEL + " = " + "1";
    ...
    public List<Question> getAllGrade11Level2QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "11" + " AND " + LEVEL + " = " + "2";
    ...
    public List<Question> getAllGrade11Level3QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "11" + " AND " + LEVEL + " = " + "3";
    ...
    public List<Question> getAllGrade12Level1QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "12" + " AND " + LEVEL + " = " + "1";
    ...
    public List<Question> getAllGrade12Level2QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "12" + " AND " + LEVEL + " = " + "2";
    ...
    public List<Question> getAllGrade12Level3QuestionsList() {
        List<Question> questionArrayList = new ArrayList<>();
        String selectQuery = "SELECT  * FROM " + TABLE_QUESTION + " WHERE " + GRADE + " = " + "12" + " AND " + LEVEL + " = " + "3";
