...
public class Grade12Level2ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade12_level2_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade12Level2ScoreActivity.this, Grade12Level2Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade12Level2ScoreActivity.this, Grade12Level3Activity.class);
        startActivity(intent);
    }
}
