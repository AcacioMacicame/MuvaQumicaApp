...
public class Grade11Level1ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade11_level1_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade11Level1ScoreActivity.this, Grade11Level1Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade11Level1ScoreActivity.this, Grade11Level2Activity.class);
        startActivity(intent);
    }
}
