...
public class Grade12Level1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grade12_level1);
        ...
        controller.grade12Questions(getApplicationContext());
        updateQuestion();
    }
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<controller.getLength() ){
            ...
            Toast.makeText(Grade12Level1Activity.this, "Nivel 1 Completo!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Grade12Level1Activity.this, Grade12Level1ScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
            Toast.makeText(Grade12Level1Activity.this, "Opção correcta!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(Grade12Level1Activity.this, "Opss, opção Errada!", Toast.LENGTH_SHORT).show();
