...
public class Grade10Level1ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade10_level1_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade10Level1ScoreActivity.this, Grade10Level1Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade10Level1ScoreActivity.this, Grade10Level2Activity.class);
        startActivity(intent);
    }
}
