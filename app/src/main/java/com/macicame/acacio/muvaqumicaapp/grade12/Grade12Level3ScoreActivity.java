...
public class Grade12Level3ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade12_level3_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade12Level3ScoreActivity.this, Grade12Level3Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade12Level3ScoreActivity.this, Grade12ReportActivity.class);
        startActivity(intent);
    }
}
