...
public class Grade11Level2ScoreActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_grade11_level2_score);
    ...
    public void onRepeatClick(View view) {
        Intent intent = new Intent(Grade11Level2ScoreActivity.this, Grade11Level2Activity.class);
        startActivity(intent);
    }

    public void onNextClick(View view) {
        Intent intent = new Intent(Grade11Level2ScoreActivity.this, Grade11Level3Activity.class);
        startActivity(intent);
    }
}
